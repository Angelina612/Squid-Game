...
class Player{
    ...
    run(){
        this.playerInfo.veclocity= -0.03;
    }

    stop(){
        gsap.to(this.playerInfo,{veclocity: 0,duration: 0.5})
    }

    check(){
        if(this.playerInfo.veclocity !=0 && !isLookingBackward){
    ...
    update(){
        this.check()
        this.playerInfo.positionX+=this.playerInfo.veclocity;
